...
function create_fragment(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      div = claim_element(nodes, "DIV", { "aria-label": true });
...
function create_fragment2(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      set_attributes(div, div_data);
      add_location(div, file2, 17, 0, 410);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (default_slot) {
...
function create_if_block(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file3, 17, 8, 550);
    },
    m: function mount(target, anchor) {
...
function create_fragment3(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file3, 15, 0, 414);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
...
function instance3($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("closeButtonProps" in $$new_props) $$invalidate(0, closeButtonProps = $$new_props.closeButtonProps);
    if ("showCloseButton" in $$new_props) $$invalidate(1, showCloseButton = $$new_props.showCloseButton);
    if ("enableEscapeToClose" in $$new_props) $$invalidate(6, enableEscapeToClose = $$new_props.enableEscapeToClose);
    if ("imagePreset" in $$new_props) $$invalidate(2, imagePreset = $$new_props.imagePreset);
  };
  $$self.$capture_state = () => ({
    createEventDispatcher,
    dispatch,
  ...
  $$self.$inject_state = ($$new_props) => {
    if ("closeButtonProps" in $$props) $$invalidate(0, closeButtonProps = $$new_props.closeButtonProps);
    if ("showCloseButton" in $$props) $$invalidate(1, showCloseButton = $$new_props.showCloseButton);
    if ("enableEscapeToClose" in $$props) $$invalidate(6, enableEscapeToClose = $$new_props.enableEscapeToClose);
    if ("imagePreset" in $$props) $$invalidate(2, imagePreset = $$new_props.imagePreset);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function instance4($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("imagePreset" in $$props2) $$invalidate(0, imagePreset = $$props2.imagePreset);
    if ("enableImageExpand" in $$props2) $$invalidate(1, enableImageExpand = $$props2.enableImageExpand);
...
function create_fragment5(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      add_location(h2, file5, 14, 4, 534);
      add_location(h5, file5, 17, 4, 569);
      set_attributes(div, div_data);
      toggle_class(
        div,
        "fullscreen",
      ...
      add_location(div, file5, 13, 0, 428);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
...
function instance5($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    $$props = assign(assign({}, $$props), exclude_internal_props($$new_props));
    $$invalidate(5, $$restProps = compute_rest_props($$props, omit_props_names));
    if ("imagePreset" in $$new_props) $$invalidate(0, imagePreset = $$new_props.imagePreset);
    if ("title" in $$new_props) $$invalidate(1, title = $$new_props.title);
    if ("description" in $$new_props) $$invalidate(2, description = $$new_props.description);
    if ("gallery" in $$new_props) $$invalidate(3, gallery = $$new_props.gallery);
  };
  $$self.$capture_state = () => ({
    i18n: i18n_default,
    imagePreset,
  ...
  $$self.$inject_state = ($$new_props) => {
    if ("imagePreset" in $$props) $$invalidate(0, imagePreset = $$new_props.imagePreset);
    ...
    if ("gallery" in $$props) $$invalidate(3, gallery = $$new_props.gallery);
    if ("localizedGalleryCounter" in $$props) $$invalidate(4, localizedGalleryCounter = $$new_props.localizedGalleryCounter);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function create_fragment6(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file6, 4, 0, 102);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (default_slot) {
...
function instance6($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    $$props = assign(assign({}, $$props), exclude_internal_props($$new_props));
    $$invalidate(1, $$restProps = compute_rest_props($$props, omit_props_names));
    if ("transitionDuration" in $$new_props) $$invalidate(0, transitionDuration = $$new_props.transitionDuration);
    if ("$$scope" in $$new_props) $$invalidate(2, $$scope = $$new_props.$$scope);
  };
  $$self.$capture_state = () => ({ fade, transitionDuration });
  $$self.$inject_state = ($$new_props) => {
    if ("transitionDuration" in $$props) $$invalidate(0, transitionDuration = $$new_props.transitionDuration);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function create_fragment7(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      add_location(div, file7, 5, 0, 126);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (default_slot) {
    ...
    i: function intro(local) {
      ...
      if (local) {
        add_render_callback(() => {
          if (!current) return;
          if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { duration: (
            /*transitionDuration*/
            ctx[0]
          ) }, true);
...
function instance7($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("transitionDuration" in $$new_props) $$invalidate(0, transitionDuration = $$new_props.transitionDuration);
    if ("imagePreset" in $$new_props) $$invalidate(1, imagePreset = $$new_props.imagePreset);
    if ("$$scope" in $$new_props) $$invalidate(3, $$scope = $$new_props.$$scope);
  };
  $$self.$capture_state = () => ({ fade, transitionDuration, imagePreset });
  $$self.$inject_state = ($$new_props) => {
    if ("transitionDuration" in $$props) $$invalidate(0, transitionDuration = $$new_props.transitionDuration);
    if ("imagePreset" in $$props) $$invalidate(1, imagePreset = $$new_props.imagePreset);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function create_if_block_1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(64:0) {#if $$slots.thumbnail || enableFallbackThumbnail}",
    ctx
  });
  return block;
}
...
function create_if_block_2(ctx) {
  ...
  const block = {
    ...
    l: function claim(nodes) {
      if (thumbnail_slot) thumbnail_slot.l(nodes);
    },
    m: function mount(target, anchor) {
      if (thumbnail_slot) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(66:2) {#if $$slots.thumbnail}",
    ctx
  });
  return block;
}
function create_default_slot_4(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(65:1) <Thumbnail {...(customization?.thumbnailProps || {})} on:click={toggle}>",
    ctx
  });
  return block;
}
...
function create_default_slot_3(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(81:4) <Body {imagePreset} {enableImageExpand}>",
    ctx
  });
  return block;
}
function create_default_slot_2(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      8) body_changes.imagePreset = /*imagePreset*/
      ctx2[3];
      if (dirty & /*enableImageExpand*/
      64) body_changes.enableImageExpand = /*enableImageExpand*/
      ctx2[6];
      if (dirty & /*$$scope*/
      524288) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(77:3) <Modal {imagePreset} {transitionDuration} on:click={modalClick} {...(customization.lightboxProps || {})}>",
    ctx
  });
  return block;
}
function create_default_slot_1(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(76:2) <ModalCover {transitionDuration} {...(customization.coverProps || {})} on:click={coverClick}>",
    ctx
  });
  return block;
}
...
function instance8($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("imagePreset" in $$props2) $$invalidate(3, imagePreset = $$props2.imagePreset);
    if ("customization" in $$props2) $$invalidate(4, customization = $$props2.customization);
    if ("transitionDuration" in $$props2) $$invalidate(5, transitionDuration = $$props2.transitionDuration);
    if ("keepBodyScroll" in $$props2) $$invalidate(15, keepBodyScroll = $$props2.keepBodyScroll);
    if ("enableImageExpand" in $$props2) $$invalidate(6, enableImageExpand = $$props2.enableImageExpand);
    if ("enableFallbackThumbnail" in $$props2) $$invalidate(7, enableFallbackThumbnail = $$props2.enableFallbackThumbnail);
    if ("enableEscapeToClose" in $$props2) $$invalidate(8, enableEscapeToClose = $$props2.enableEscapeToClose);
    if ("enableClickToClose" in $$props2) $$invalidate(16, enableClickToClose = $$props2.enableClickToClose);
    if ("showCloseButton" in $$props2) $$invalidate(9, showCloseButton = $$props2.showCloseButton);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("showCloseButton" in $$props2) $$invalidate(9, showCloseButton = $$props2.showCloseButton);
    if ("isVisible" in $$props2) $$invalidate(0, isVisible = $$props2.isVisible);
    if ("modalClicked" in $$props2) modalClicked = $$props2.modalClicked;
    if ("toggleScroll" in $$props2) toggleScroll = $$props2.toggleScroll;
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function add_css7(target) {
  append_styles(target, "svelte-cicxma", "button.svelte-cicxma{background:transparent;border:none;font-size:1rem;width:50%;height:100%}button.svelte-cicxma:active{background:transparent}button.svelte-cicxma:disabled{color:gray}button:disabled.hideDisabled.svelte-cicxma{visibility:hidden}svg.svelte-cicxma{display:inline-block;height:5rem}.previous-button.svelte-cicxma{position:absolute;top:0;bottom:0;left:0;right:50%;z-index:4;text-align:left}.arrow.svelte-cicxma{fill:none;stroke:var(--svelte-lightbox-arrows-color);stroke-linecap:round;stroke-linejoin:bevel;stroke-width:1.5px;margin:10px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment9(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "class", "arrow svelte-cicxma");
      attr_dev(path, "d", "M8.7,7.22,4.59,11.33a1,1,0,0,0,0,1.41l4,4");
      add_location(path, file8, 8, 12, 309);
      add_location(g, file8, 7, 8, 293);
      attr_dev(svg, "viewBox", "0 0 24 24");
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "class", "svelte-cicxma");
      add_location(svg, file8, 6, 4, 224);
      button.disabled = button_disabled_value = /*character*/
      ctx[1] !== "loop" && /*activeImage*/
      ctx[0] === 0;
      attr_dev(button, "class", "previous-button svelte-cicxma");
      toggle_class(
        button,
        "hideDisabled",
        /*character*/
      ...
      add_location(button, file8, 4, 0, 75);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, button, anchor);
...
function instance9($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot") console.warn(`<PreviousImageButton> was created with unknown prop '${key}'`);
  });
  function click_handler(event) {
    bubble.call(this, $$self, event);
  }
  $$self.$$set = ($$props2) => {
    if ("activeImage" in $$props2) $$invalidate(0, activeImage = $$props2.activeImage);
    if ("character" in $$props2) $$invalidate(1, character = $$props2.character);
  };
...
function add_css8(target) {
  append_styles(target, "svelte-3r5obh", "button.svelte-3r5obh{background:transparent;border:none;font-size:1rem;width:50%;height:100%}button.svelte-3r5obh:active{background:transparent}button.svelte-3r5obh:disabled{color:gray}button:disabled.hideDisabled.svelte-3r5obh{visibility:hidden}svg.svelte-3r5obh{display:inline-block;height:5rem}.next-button.svelte-3r5obh{position:absolute;top:0;bottom:0;right:0;z-index:4;text-align:right}.arrow.svelte-3r5obh{fill:none;stroke:var(--svelte-lightbox-arrows-color);stroke-linecap:round;stroke-linejoin:bevel;stroke-width:1.5px;margin:10px}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment10(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      attr_dev(path, "class", "arrow svelte-3r5obh");
      add_location(path, file9, 9, 12, 341);
      add_location(g, file9, 8, 8, 325);
      attr_dev(svg, "viewBox", "0 0 24 24");
      attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
      attr_dev(svg, "class", "svelte-3r5obh");
      add_location(svg, file9, 7, 4, 256);
      button.disabled = button_disabled_value = /*character*/
      ctx[2] !== "loop" && /*activeImage*/
      ctx[1] === /*imageCount*/
      ctx[0] - 1;
      attr_dev(button, "class", "next-button svelte-3r5obh");
      toggle_class(
        button,
        "hideDisabled",
        /*character*/
      ...
      add_location(button, file9, 5, 0, 98);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, button, anchor);
      append_hydration_dev(button, svg);
...
function instance10($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot") console.warn(`<NextImageButton> was created with unknown prop '${key}'`);
  });
  function click_handler(event) {
    bubble.call(this, $$self, event);
  }
  $$self.$$set = ($$props2) => {
    if ("imageCount" in $$props2) $$invalidate(0, imageCount = $$props2.imageCount);
    if ("activeImage" in $$props2) $$invalidate(1, activeImage = $$props2.activeImage);
    if ("character" in $$props2) $$invalidate(2, character = $$props2.character);
  };
...
function create_fragment11(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, [dirty]) {
      ...
      16) previousimagebutton_changes.activeImage = /*$activeImageStore*/
      ctx2[4];
      if (dirty & /*$arrowsConfigStore*/
      8) previousimagebutton_changes.character = /*$arrowsConfigStore*/
      ctx2[3].character;
      ...
      if (dirty & /*$activeImageStore*/
      16) nextimagebutton_changes.activeImage = /*$activeImageStore*/
      ctx2[4];
      if (dirty & /*$imageCountStore*/
      32) nextimagebutton_changes.imageCount = /*$imageCountStore*/
      ctx2[5];
      if (dirty & /*$arrowsConfigStore*/
      8) nextimagebutton_changes.character = /*$arrowsConfigStore*/
      ctx2[3].character;
    ...
    d: function destroy(detaching) {
      ...
      if (detaching && previousimagebutton) detach_dev(div);
      destroy_component(previousimagebutton, detaching);
      if (default_slot) default_slot.d(detaching);
      if (detaching && nextimagebutton) detach_dev(div_1);
...
function instance11($$self, $$props, $$invalidate) {
  ...
  Object.keys($$props).forEach((key) => {
    if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$" && key !== "slot") console.warn(`<GalleryController> was created with unknown prop '${key}'`);
  });
  const keydown_handler = (event) => handleKey(event);
  $$self.$$set = ($$props2) => {
    if ("imagePreset" in $$props2) $$invalidate(9, imagePreset = $$props2.imagePreset);
    if ("imageCountStore" in $$props2) $$subscribe_imageCountStore($$invalidate(0, imageCountStore = $$props2.imageCountStore));
    if ("activeImageStore" in $$props2) $$subscribe_activeImageStore($$invalidate(1, activeImageStore = $$props2.activeImageStore));
    if ("arrowsConfigStore" in $$props2) $$subscribe_arrowsConfigStore($$invalidate(2, arrowsConfigStore = $$props2.arrowsConfigStore));
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("activeImageStore" in $$props2) $$subscribe_activeImageStore($$invalidate(1, activeImageStore = $$props2.activeImageStore));
    if ("arrowsConfigStore" in $$props2) $$subscribe_arrowsConfigStore($$invalidate(2, arrowsConfigStore = $$props2.arrowsConfigStore));
    if ("fullscreen" in $$props2) fullscreen = $$props2.fullscreen;
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
...
function create_if_block_12(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(104:0) {#if $$slots.thumbnail}",
    ctx
  });
  return block;
}
function create_if_block4(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      const bodychild_changes = {};
      if (dirty[0] & /*$$scope, transitionDuration, customization, imagePreset, activeImageTitle, activeImageDescription, gallery, enableImageExpand, showCloseButton, enableEscapeToClose*/
      268436478) {
        bodychild_changes.$$scope = { dirty, ctx: ctx2 };
      }
      bodychild.$set(bodychild_changes);
...
function create_default_slot_42(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(116:24) <GalleryController {imagePreset} {imageCountStore} {activeImageStore} {arrowsConfigStore}>",
    ctx
  });
  return block;
}
function create_default_slot_32(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      2) gallerycontroller_changes.imagePreset = /*imagePreset*/
      ctx2[1];
      if (dirty[0] & /*$$scope*/
      268435456) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(115:20) <Body {imagePreset} {enableImageExpand}>",
    ctx
  });
  return block;
}
function create_default_slot_22(ctx) {
  ...
  const header_spread_levels = [
    ...
    },
    {
      closeButtonProps: (
        /*customization*/
        ctx[2].closeButtonProps
      )
    },
    /*customization*/
    ctx[2].lightboxHeaderProps || {}
  ];
  let header_props = {};
  for (let i = 0; i < header_spread_levels.length; i += 1) {
    header_props = assign(header_props, header_spread_levels[i]);
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      102 ? get_spread_update(header_spread_levels, [
        dirty[0] & /*imagePreset*/
        2 && { imagePreset: (
          /*imagePreset*/
          ctx2[1]
        ...
        4 && {
          closeButtonProps: (
            /*customization*/
            ctx2[2].closeButtonProps
          )
        },
        dirty[0] & /*customization*/
        4 && get_spread_object(
          /*customization*/
          ctx2[2].lightboxHeaderProps || {}
        )
      ]) : {};
      header.$set(header_changes);
      const body_changes = {};
      if (dirty[0] & /*imagePreset*/
      2) body_changes.imagePreset = /*imagePreset*/
      ctx2[1];
      if (dirty[0] & /*enableImageExpand*/
      16) body_changes.enableImageExpand = /*enableImageExpand*/
      ctx2[4];
      ...
      body.$set(body_changes);
      const footer_changes = dirty[0] & /*imagePreset, activeImageTitle, activeImageDescription, gallery, customization*/
      902 ? get_spread_update(footer_spread_levels, [
        dirty[0] & /*imagePreset*/
        2 && { imagePreset: (
          /*imagePreset*/
          ctx2[1]
        ) },
        dirty[0] & /*activeImageTitle*/
        512 && { title: (
          /*activeImageTitle*/
          ctx2[9]
        ) },
        dirty[0] & /*activeImageDescription*/
        256 && {
          description: (
            /*activeImageDescription*/
            ctx2[8]
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(111:12) <Modal {imagePreset} {transitionDuration} {...(customization.lightboxProps || {})} on:click={modalClick}>",
    ctx
  });
  return block;
}
function create_default_slot_12(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      14 ? get_spread_update(modal_spread_levels, [
        dirty[0] & /*imagePreset*/
        2 && { imagePreset: (
          /*imagePreset*/
          ctx2[1]
        ...
        4 && get_spread_object(
          /*customization*/
          ctx2[2].lightboxProps || {}
        )
      ]) : {};
      if (dirty[0] & /*$$scope, imagePreset, activeImageTitle, activeImageDescription, gallery, customization, enableImageExpand, showCloseButton, enableEscapeToClose*/
      268436470) {
        modal_changes.$$scope = { dirty, ctx: ctx2 };
      }
      modal.$set(modal_changes);
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "slot",
    source: "(110:8) <ModalCover {transitionDuration} {...(customization.coverProps || {})} on:click={coverClick}>",
    ctx
  });
  return block;
}
function create_default_slot2(ctx) {
  ...
  const block = {
    ...
    p: function update(ctx2, dirty) {
      ...
      12 ? get_spread_update(modalcover_spread_levels, [
        dirty[0] & /*transitionDuration*/
        8 && {
          transitionDuration: (
            /*transitionDuration*/
      ...
      if (dirty[0] & /*$$scope, imagePreset, transitionDuration, customization, activeImageTitle, activeImageDescription, gallery, enableImageExpand, showCloseButton, enableEscapeToClose*/
      268436478) {
        modalcover_changes.$$scope = { dirty, ctx: ctx2 };
      }
      modalcover.$set(modalcover_changes);
...
function instance12($$self, $$props, $$invalidate) {
  ...
  validate_store(imageCountStore, "imageCountStore");
  component_subscribe($$self, imageCountStore, (value) => $$invalidate(26, $imageCountStore = value));
  const activeImageStore = writable(activeImage);
  validate_store(activeImageStore, "activeImageStore");
  component_subscribe($$self, activeImageStore, (value) => $$invalidate(25, $activeImageStore = value));
  ...
  const keepOrEmptyImageList = (isVisible2) => {
    if (!isVisible2) $$invalidate(24, images = []);
  };
  let toggleScroll = () => {
  };
  ...
  setContext("imageCounter", (image) => {
    ...
    $$invalidate(24, images = [...images, image]);
  ...
  $$self.$$set = ($$props2) => {
    if ("title" in $$props2) $$invalidate(18, title = $$props2.title);
    if ("description" in $$props2) $$invalidate(19, description = $$props2.description);
    if ("imagePreset" in $$props2) $$invalidate(1, imagePreset = $$props2.imagePreset);
    if ("customization" in $$props2) $$invalidate(2, customization = $$props2.customization);
    if ("transitionDuration" in $$props2) $$invalidate(3, transitionDuration = $$props2.transitionDuration);
    if ("keepBodyScroll" in $$props2) $$invalidate(20, keepBodyScroll = $$props2.keepBodyScroll);
    if ("enableImageExpand" in $$props2) $$invalidate(4, enableImageExpand = $$props2.enableImageExpand);
    if ("enableEscapeToClose" in $$props2) $$invalidate(5, enableEscapeToClose = $$props2.enableEscapeToClose);
    if ("enableClickToClose" in $$props2) $$invalidate(21, enableClickToClose = $$props2.enableClickToClose);
    if ("showCloseButton" in $$props2) $$invalidate(6, showCloseButton = $$props2.showCloseButton);
    if ("isVisible" in $$props2) $$invalidate(0, isVisible = $$props2.isVisible);
    if ("activeImage" in $$props2) $$invalidate(17, activeImage = $$props2.activeImage);
    if ("arrowsConfig" in $$props2) $$invalidate(22, arrowsConfig = $$props2.arrowsConfig);
  ...
  $$self.$inject_state = ($$props2) => {
    ...
    if ("arrowsConfig" in $$props2) $$invalidate(22, arrowsConfig = $$props2.arrowsConfig);
    if ("modalClicked" in $$props2) modalClicked = $$props2.modalClicked;
    if ("images" in $$props2) $$invalidate(24, images = $$props2.images);
    if ("thumbnailCount" in $$props2) thumbnailCount = $$props2.thumbnailCount;
    if ("toggleScroll" in $$props2) toggleScroll = $$props2.toggleScroll;
    if ("gallery" in $$props2) $$invalidate(7, gallery = $$props2.gallery);
    if ("activeImageDescription" in $$props2) $$invalidate(8, activeImageDescription = $$props2.activeImageDescription);
    if ("activeImageTitle" in $$props2) $$invalidate(9, activeImageTitle = $$props2.activeImageTitle);
  };
  if ($$props && "$$inject" in $$props) {
    $$self.$inject_state($$props.$$inject);
  }
  $$self.$$.update = () => {
    ...
    50593792) {
      $: $$invalidate(9, activeImageTitle = ((_a = images[$activeImageStore]) == null ? void 0 : _a.title) || title || "");
    }
    if ($$self.$$.dirty[0] & /*images, $activeImageStore, description*/
    50855936) {
      $: $$invalidate(8, activeImageDescription = ((_b = images[$activeImageStore]) == null ? void 0 : _b.description) || description || "");
    }
    if ($$self.$$.dirty[0] & /*$imageCountStore, $activeImageStore*/
    100663296) {
      $: $$invalidate(7, gallery = {
  ...
  constructor(options) {
    ...
    init(
      ...
      safe_not_equal,
      {
        ...
        keepBodyScroll: 20,
        enableImageExpand: 4,
        enableEscapeToClose: 5,
        enableClickToClose: 21,
        showCloseButton: 6,
        isVisible: 0,
        activeImage: 17,
        arrowsConfig: 22,
        programmaticController: 23
      },
      null,
      [-1, -1]
    );
...
function add_css9(target) {
  append_styles(target, "svelte-hpqpx9", "div.svelte-hpqpx9{position:static;cursor:zoom-in}.svelte-lightbox-thumbnail > *{max-width:100%;height:auto}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */");
}
function create_fragment13(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      ...
      toggle_class(div, "svelte-lightbox-thumbnail", true);
      toggle_class(div, "svelte-hpqpx9", true);
      add_location(div, file10, 9, 0, 239);
    },
    m: function mount(target, anchor) {
      insert_hydration_dev(target, div, anchor);
      if (default_slot) {
...
function create_if_block5(ctx) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(12:0) {#if $activeImageStore === imageId}",
    ctx
  });
  return block;
}
...
var GalleryImage = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance14, create_fragment14, safe_not_equal, { title: 4, description: 5 });
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
